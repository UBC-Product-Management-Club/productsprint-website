      ...
      <div className='project_meta'>
        ...
        <div className='project_meta_intro'>
          <p>
            ...
            the metro. This was initially scary and challenging as a foreigner.
            Everything was going smoothly until I got to San Jose and stepped
            out of the station. I realized I had no idea which way to turn. I
            opened Apple Maps on my phone to find the directions and discovered
            there was a new feature. Users who have a compatible phone can use
            the augmented reality (AR) walking directions feature to see AR
            directions through their iPhone camera lens. It is as simple as
            pointing the phone at my surroundings and seeing a floating arrow
            pointing me in the direction I needed to walk in. This saved me from
            the awkwardness of spinning around to have my map calibrate my
            location. Since that experience, Apple Maps has been a favourite app
            of mine as it distinguishes itself from its competitors by merging
            hardware and software to assist directionally challenged
            individuals, like me.&nbsp;
          </p>
          <img
          ...
          <p>
            ...
            road-level perspective and 3D landmark exploration. These additional
            features push Maps beyond a regular GPS map.
          </p>
        </div>
      ...
      <div className='project_container'>
        <article className='mt-2 text-md text-basicSurface-700'>
          ...
          <p>
            ...
            lanes” which move vehicles along at a faster frequency as the
            special lanes have minimum requirements. The lack of HOV identifiers
            in Maps can result in inflated commute times for drivers.
          </p>
          <p>
          ...
          <ul className='list-disc list-inside pl-6'>
            <li>
              <p>
                ...
                attempt to drive in HOV lanes despite being qualified to do so.
              </p>
            </li>
            <li>
          ...
          <p>
            ...
            Maps' inability to allow users to arrive at their destination in an
            efficient manner unlike competitors – namely Google Maps and Waze.
            These user frustrations will be explored in the following User
            Persona and Opportunity sections.
          </p>
          <h2 className='text-lg'>
          ...
          <p>
            ...
            were those working in white-collar jobs that required them to travel
            frequently. These users also tend to have more than one navigation
            app on their mobile devices to compare the quickest and most
            accurate route. The User Persona below highlights a regular user of
            Apple Maps.
          </p>
          <figure>
            <div
          ...
          <p>
            ...
            and allow them to regain time in their day. The underlying reason
            for the establishment of HOV lanes (reducing vehicle emissions)
            contributes to Apple's long-term goal of combating climate change.
            This can encourage Apple Maps users to seek emission-reducing
            methods without compromising on travel time.
          </p>
          <h2 className='text-lg'>
          ...
          <p>
            ...
            their navigation needs. By testing the functionality on Waze, I can
            better understand what users may like to experience using this
          ...
          <p>
            ...
            interviews. Rather than asking a specific question which could lead
            them to prioritize certain answers, open questions allowed
